...
import {
  ...
  dataExists
} from '../../services/master/bundlingRulesService'
...
exports.getData = function (req, res, next) {
  console.log('Requesting-getStocksBundling: ' + req.url + ' ...')
...
exports.insertData = function (req, res, next) {
  console.log('Requesting-insertData-BundlingRules: ' + req.url + ' ...')
  const data = req.body
...
exports.updateData = function (req, res, next) {
  console.log('Requesting-updateDataBundlingRules: ' + req.url + ' ...')
  const id = req.params.id
  console.log('id', id)
  let data = req.body
  const userLogIn = extractTokenProfile(req)
