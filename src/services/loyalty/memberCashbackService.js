...
export function getDataByPosId (id) {
  return table.findOne({
    where: {
      posId: id,
      type: 'I',
...
export function dataExistsCode (id) {
...
export function insertData (data, createdBy, next) {
  return table.create({
    ...
    loyaltySetValue: data.loyaltySetValue,
    cashbackIn: data.cashbackIn,
    cashbackOut: data.cashbackOut,
    createdBy: createdBy,
    updatedBy: '---'
  })
}
